<!-- 
This is the search page, containing the entrence of search by image, voice and typing
 -->
<template>
  <view class="main-body">
    ...
    <view class="u-demo-wrap search-page-body">
      ...
      >
        ...
        <view class="title"
          >Welcome to L-Helper, you can search a word by taking photo, speaking
          and typing!
        </view>
        <u-row class="search">
          <u-col span="12">
      ...
      >
        <u-col :span="10" :offset="1" stop>
          <u-swipe-action
            ...
            :options="options"
            :disabled="item.show"
            @content-click="contentClick(item)"
          >
            <view class="item u-border-bottom">
              ...
              <u-icon
                @click.native.stop="cancelCollected(item)"
